...
class DigestAlgorithmEncryptionTest {
    ...
    void testMD2Encription() {
        ...
        String actual = DigestAlgorithmEncryption.encryptString(originalString, "MD2");
        assertEquals(expected, actual, "should encrypt with MD2");
    }

    @Test
    void testMD5Encription() {
        String expected = "919c8b643b7133116b02fc0d9bb7df3f";
        String actual = DigestAlgorithmEncryption.encryptString(originalString, "MD5");
        assertEquals(expected, actual, "should encrypt with MD2");
    }
    ...
    void testSHA1Encription() {
        ...
        String actual = DigestAlgorithmEncryption.encryptString(originalString, "SHA-1");
        assertEquals(expected, actual, "should encrypt with SHA-1");
    }

    @Test
    void testSHA244Encription() {
        String expected = "3f90eb8c61672169a2889615823bd77849e471867d7902cc0fc5eb8a";
        String actual = DigestAlgorithmEncryption.encryptString(originalString, "SHA-224");
        assertEquals(expected, actual, "should encrypt with SHA-224");
    }

    @Test
    void testSHA256Encription() {
        String expected = "0682c5f2076f099c34cfdd15a9e063849ed437a49677e6fcc5b4198c76575be5";
        String actual = DigestAlgorithmEncryption.encryptString(originalString, "SHA-256");
        assertEquals(expected, actual, "should encrypt with SHA-256");
    }
    ...
    void testSHA384Encription() {
        ...
        String actual = DigestAlgorithmEncryption.encryptString(originalString, "SHA-384");
        assertEquals(expected, actual, "should encrypt with SHA-384");
    }
    ...
    void testSHA512Encription() {
        ...
        String actual = DigestAlgorithmEncryption.encryptString(originalString, "SHA-512");
        assertEquals(expected, actual, "should encrypt with SHA-512");
    }
}
